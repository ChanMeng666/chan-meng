      ...
      const answer = await inquirer.prompt([
        {
          type: 'list',
          name: 'action',
          message: 'Philosophy complete. What would you like to do?',
          choices: [
