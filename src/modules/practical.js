      ...
      const answer = await inquirer.prompt([
        {
          type: 'list',
          name: 'action',
          message: 'Practical examples complete. What would you like to do?',
          choices: [
